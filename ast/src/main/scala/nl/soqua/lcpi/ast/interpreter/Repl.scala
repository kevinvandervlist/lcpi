...
object ReplExpression {
  ...
  implicit def re2e(e: Expression): nl.soqua.lcpi.ast.lambda.Expression = e.expression
...
case class Expression(expression: nl.soqua.lcpi.ast.lambda.Expression) extends ReplExpression
